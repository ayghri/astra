...
def get_wide_resnet_22(*args, **kwargs):
    return WideResNet(depth=22, widen_factor=2, num_classes=10, small_dense_density=1.0)


@ModelFactory.register_model_loader(model="wide_resnet22", dataset="cifar100")
def get_wide_resnet_22_cifar100(*args, **kwargs):
    return WideResNet(depth=22, widen_factor=2, num_classes=100, small_dense_density=1.0)
