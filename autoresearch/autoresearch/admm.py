...
W_PATH = "/scratch/alpine/aygh9582/data/layer_0_W.cpt"
X_PATH = "/scratch/alpine/aygh9582/data/layer_0_X.cpt"
...
def main(skip_ols=True):
    W0 = torch.load(W_PATH, map_location="cpu", weights_only=True).float().to(DEVICE)
